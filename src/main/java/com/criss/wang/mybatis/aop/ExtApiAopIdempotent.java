...
public class ExtApiAopIdempotent {
    @Autowired
    private RedisService redisTokenUtils;

    @Pointcut("execution(public * com.criss.wang.mybatis.controller.*.*(..))")
    public void rlAop() {
    }
